...
export default function StepConfirm({ onReset }: StepConfirmProps) {
  return (
    <div className="w-full max-w-xl mx-auto px-4 py-12 text-center">
      ...
      >
        Your order has been submitted. A member of the 4A team will be in touch
      ...
      <motion.div
        ...
        className="mb-8"
      >
        <p className="text-text-muted text-sm mb-2">Need it sooner? Call us now</p>
        <a
