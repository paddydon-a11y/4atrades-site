        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <AnimatedSection delay={0.2}>
            <div className="mt-12 bg-card border border-accent rounded-lg p-10">
              ...
              <p className="font-[family-name:var(--font-display)] text-3xl md:text-4xl text-text-muted mt-3 line-through decoration-red-500 decoration-3">
                £14,995
              </p>
              <p className="font-[family-name:var(--font-display)] text-6xl md:text-7xl text-accent mt-1">
                £4,995
              </p>
